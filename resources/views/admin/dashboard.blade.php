...
<div class="content">
	...
	<?php
	$income = \App\Http\Controllers\AdminController::getDashboardIncome($branch->id);
			...
			<div class="block block-rounded block-bordered">
				<div class="block-header block-header-default border-b">
					<h3 class="block-title">
						ยอดขาย <small>รายสัปดาห์</small>
					</h3>
				</div>
				<div class="block-content block-content-full">
					<div class="pull-all pt-50"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
					<canvas class="js-chartjs-dashboard-lines2 chartjs-render-monitor" width="559" height="100" style="display: block; width: 559px; height: 100px;"></canvas>
				</div>
			</div>
		</div>
	</div>
