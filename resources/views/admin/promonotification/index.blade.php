@extends('master')
@section('title','จัดการโปรโมชั่นทั้งหมด')
@section('style')
...
@section('content')
<div class="content">
	<h2 class="content-heading">เรียกดูโปรโมชั่น</h2>
	<div class="block">
			<form id="mainform" method="POST">
				...
				<div class="block-content">
					...
					<div class="form-group row">
						<div class="col-12">
							<button data-url="/admin/promotionnotification/specific" class="btn btn-primary pull-right submitbtn">เรียกดูโปรโมชั่น</button>
							<button data-url="/admin/promotionnotification/groupprint" class="btn btn-warning pull-right submitbtn">พิมพ์ป้ายรายเดือน</button>
						</div>
						<br><br>
					</div>
				</div>
	...
	<div class="block">
		<div class="block-content">
			<div style="width: 100%; text-align: right;">
				<a href="/admin/promonotification/create" class="btn btn-success"><i class="fa fa-plus"></i> สร้างโปรโมชั่น</a>
			</div>
			<br><br>
					...
					<tbody>
						...
						<tr class="{{$status}}">
							...
							<td class="text-center" style="width: 100px;">
								<a href="/admin/promonotification/deletepromotion/{{$promotion->id}}" class="btn btn-danger btn-block"><i class="fa fa-trash"></i> ลบ</a>
								<a href="/admin/promonotification/get/{{$promotion->id}}" class="btn btn-primary btn-block"><i class="fa fa-info"></i> แก้ไข</a>
								<a href="/admin/promotionnotification/print/{{$promotion->id}}" target="_blank" class="btn btn-warning btn-block"><i class="fa fa-print"></i> พิมพ์ป้าย</a>
							</td>
						</tr>
						@endforeach
					</tbody>
